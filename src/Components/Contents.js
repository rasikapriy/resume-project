    ...
    about: (
      <Row gutter={[20, 20]} justify="center">
        <Col xs={24} md={8}>
          <HoverCard
            title="Background"
            content="Front-end developer with expertise in React and Ant Design."
          />
        </Col>
        <Col xs={24} md={10}>
          <HoverCard
    ...
    projects: (
      <Row gutter={[16, 16]} justify="center">
        {[
          {
            title: "Project 1",
            desc: "A React-based project with Ant Design.",
          },
          {
            title: "Project 2",
            desc: "A portfolio website built with React and CSS.",
          },
          {
            title: "Project 3",
            desc: "An interactive dashboard with data visualization.",
          },
        ].map((project, index) => (
          ...
          <HoverCard
            ...
            onClick={() =>
              (window.location.href =
                "mailto:rasikapriyabsc@gmail.com?subject=Let's%20Connect")
            }
          />
        </Col>
      </Row>
